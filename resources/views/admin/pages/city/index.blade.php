...
{{-- Active sidebar --}}
@section('content-cms', 'active subdrop')
@section('city', 'active')
...
@section('body-content')
    ...
    <div class="page-header">
        ...
        <ul class="table-top-head">
            @if(auth("admin")->user()->can("pdf.city"))
                <li>
                    <a data-bs-toggle="tooltip" data-bs-placement="top" href="{{ route('admin.city.pdf') }}" aria-label="Pdf" data-bs-original-title="Pdf"><img src="{{ asset('public/admin/assets/img/icons/pdf.svg') }}" alt="img"></a>
                </li>
            @endif

            @if(auth("admin")->user()->can("excel.city"))
                <li>
        ...
        <div class="page-btn">
            @if(auth("admin")->user()->can("create.city"))
                <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#createModal"><i class="ti ti-circle-plus me-1"></i>Add City</button>
             @endif
        </div>
    </div>
    ...
    <div class="card">
                    ...
                    <div class="modal-body">
                        <form id="createForm" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <span id="country_name_validate" class="text-danger validation-error mt-1"></span>
                            </div>

                            <div class="mb-3">
                                <label for="state_name" class="form-label">State Name <span class="text-danger">*</span></label>
                                <select class="form-select select2" id="state_name" name="state_id">
                                    @foreach ($states as $row)
                                        <option value="{{ $row->id }}">{{ $row->state_name }}</option>
                                    @endforeach
                                </select>

                                <span id="state_name_validate" class="text-danger validation-error mt-1"></span>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <span id="city_name_validate" class="text-danger validation-error mt-1"></span>
                            </div>
                    ...
                    <div class="modal-body">
                        <form id="EditForm" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select select2" id="up_state_name"  name="state_id">
                                    @foreach ($states as $row)
                                        <option value="{{ $row->id }}">{{ $row->state_name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-3">
                                <label for="up_city_name" class="form-label">City Name <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="up_city_name" name="city_name">

                                <span id="up_city_name_validate" class="text-danger validation-error mt-1"></span>
                            </div>
        ...
        style="display: none;" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="myModalLabel">View City List</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="view_modal_content">
                            ...
                            <span class="text-dark" id="view_city_name"></span>
                        </div>
            ...
            $('#createForm').submit(function (e) {
                ...
                $.ajax({
                    ...
                    error: function (err) {
                        ...
                        $('#city_name_validate').empty().html(error.city_name);
            ...
            $(document).on("click", '#editButton', function (e) {
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        ...
                        $('#id').val(data.id);
                        $('#up_country_name').val(data.country_id).trigger('change');
                        $('#up_state_name').val(data.state_id).trigger('change');
                        $('#up_city_name').val(data.city_name);
                        $('#up_status').val(data.status).trigger('change');
                    },
            ...
            $("#EditForm").submit(function (e) {
                ...
                $.ajax({
                    ...
                    error: function (err) {
                        ...
                        $('#up_state_name_validate').empty().html(error.state_id);
                        $('#up_city_name_validate').empty().html(error.city_name);
            ...
            $(document).on("click", '#viewButton', function (e) {
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        ...
                        $('#view_city_name').html(data.city_name);
