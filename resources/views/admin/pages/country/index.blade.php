...
@section('body-content')
    ...
    <div class="page-header">
        ...
        <ul class="table-top-head">
            @if(auth("admin")->user()->can("pdf.country"))
                <li>
                    <a data-bs-toggle="tooltip" data-bs-placement="top" href="{{ route('admin.country.pdf') }}" aria-label="Pdf" data-bs-original-title="Pdf"><img src="{{ asset('public/admin/assets/img/icons/pdf.svg') }}" alt="img"></a>
                </li>
            @endif

            @if(auth("admin")->user()->can("excel.country"))
                <li>
    ...
    <div class="card">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="myModalLabel">Create Country</h5>
                    ...
                    <div class="modal-body">
                        <form id="createForm" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <span id="country_code_validate" class="text-danger validation-error mt-1"></span>
                            </div>
                        ...
                        <form id="EditForm" enctype="multipart/form-data">
                            ...
                            <input type="text" name="id" id="id" hidden>
                             ...
                             <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="up_country_name" name="country_name">

                                <span id="up_country_name_validate" class="text-danger validation-error mt-1"></span>
                            </div>

                            <div class="mb-3">
                                <label for="up_country_code" class="form-label">Country Code <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="up_country_code" name="country_code">

                                <span id="up_country_code_validate" class="text-danger validation-error mt-1"></span>
                            </div>
        ...
        style="display: none;" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="myModalLabel">View Country List</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="view_modal_content">
                            ...
                            <span class="text-dark" id="view_country_code"></span>
                        </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $(document).on('click', '#status', function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ route('admin.country.status') }}",
                    data: {
                        // '_token': token,
                        id: id,
                        status: status
            ...
            $('#createForm').submit(function (e) {
                ...
                $.ajax({
                    ...
                    error: function (err) {
                        ...
                        $('#country_code_validate').empty().html(error.country_code);
            ...
            $(document).on("click", '#editButton', function (e) {
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        ...
                        $('#up_country_code').val(data.country_code);
            ...
            $("#EditForm").submit(function (e) {
                ...
                $.ajax({
                    ...
                    error: function (err) {
                        ...
                        $('#up_country_code_validate').empty().html(error.country_code);
            ...
            $(document).on("click", '#viewButton', function (e) {
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        ...
                        $('#view_country_code').html(data.country_code);
