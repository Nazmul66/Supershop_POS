    ...
    <div class="page-header">
        <div class="add-item d-flex">
            <div class="page-title">
                <h4 class="fw-bold">Unit</h4>
                <h6>Manage your units</h6>
            </div>
        </div>
        <ul class="table-top-head">
            @if(auth("admin")->user()->can("pdf.unit"))
                <li>
                    <a data-bs-toggle="tooltip" data-bs-placement="top" href="{{ route('admin.unit.pdf') }}" aria-label="Pdf" data-bs-original-title="Pdf"><img src="{{ asset('public/admin/assets/img/icons/pdf.svg') }}" alt="img"></a>
                </li>
            @endif

            @if(auth("admin")->user()->can("excel.unit"))
                <li>
        ...
        <div class="page-btn">
            @if(auth("admin")->user()->can("create.unit"))
                <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#createModal"><i class="ti ti-circle-plus me-1"></i>Add Unit</button>
             @endif
        </div>
    </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="EditForm" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                <label for="up_unit" class="form-label">Unit <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="up_unit" name="unit" placeholder="Unit">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="up_short_name" name="short_name" placeholder="Short Name">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="view_modal_content">
                            <label>Unit : </label>
                            <span class="text-dark" id="view_unit"></span>
                        </div>
